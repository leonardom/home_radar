          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="bg-card flex flex-col items-center rounded-xl border p-6 text-center shadow-sm">
              ...
              <p className="text-muted-foreground">
                Get notified the moment a matching property hits the
                market—never miss out again.
              </p>
            </div>
            <div className="bg-card flex flex-col items-center rounded-xl border p-6 text-center shadow-sm">
              ...
              <p className="text-muted-foreground">
                Zero in on your dream home with price, bedrooms, location, and
                keyword filters.
              </p>
            </div>
            <div className="bg-card flex flex-col items-center rounded-xl border p-6 text-center shadow-sm">
            ...
            <div className="bg-card flex flex-col items-center rounded-xl border p-6 text-center shadow-sm">
              ...
              <p className="text-muted-foreground">
                Bookmark properties you love and track them as their status
                changes.
              </p>
            </div>
          </div>
        ...
        <section className="mx-auto mb-24 w-full max-w-4xl px-2">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">
                Choose your price, bedrooms, location, and more to define your
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">
                Receive real-time notifications when a matching property is
                listed—no more FOMO.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="bg-card flex flex-col items-center rounded-xl border p-6 text-center shadow-sm">
              <p className="mb-4 italic">
                “HomeRadar found us our dream home in days. The instant alerts
                are a game changer!”
              </p>
            ...
            <div className="bg-card flex flex-col items-center rounded-xl border p-6 text-center shadow-sm">
              <p className="mb-4 italic">
                “I saved hours every week. The filters and aggregation are so
                powerful!”
              </p>
        ...
        <section className="mx-auto mb-24 w-full max-w-3xl px-2">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Set your filters and we’ll notify you by email as soon as a
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Yes, you can upgrade, downgrade, or cancel anytime from your
                account dashboard.
              </p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                Absolutely. We use industry-standard security and never share
